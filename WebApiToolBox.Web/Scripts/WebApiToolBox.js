(function() {
    ...
    getJson("/_WebApiToolBox?ApiName=" + apiId, getReadyToUseTestClient);
    ...
    function getReadyToUseTestClient(data) {
        ...
        dom.el("link", {"href": "/Content/WebApiToolBox.styles.css","rel":"stylesheet","type": "text/css"}, document.head);
    ...
    function getTemplate(callback) {
        ...
        xhr.open("GET", "/Content/WebApiToolBox.views.html");
        xhr.send();
    }
